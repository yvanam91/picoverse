...
export type BlockType = 'text' | 'image' | 'video' | 'button' | 'hero' | 'link' | 'secondary-link' | 'double-link' | 'file' | 'header' | 'social_grid' | 'separator' | 'title' | 'embed' | 'map' | 'contact' | 'internal_link'
